...
function colorChange1 (){
    ...
    if (document.querySelector("#answer1").value == ("Lucia Christina Roberta Heiser de la Cruz")){
...
function colorChange2() {
    ...
    if (document.querySelector("#answer2").value == ("2")) {
...
function colorChange3() {
    ...
    if (document.querySelector("#answer3").value == ("bananas")) {
...
function colorChange4() {
    ...
    if (document.querySelector("#answer4").value == ("Azkaban")) {
...
function colorChange5() {
    ...
    if (document.querySelector("#answer5").value == ("german shepherd border collie")) {
...
function colorChange6() {
    ...
    if (document.querySelector("#answer6").value == ("11 months")) {
...
function colorChange7() {
    ...
    if (document.querySelector("#answer7").value == ("Autumn")) {
...
function colorChange8() {
    ...
    if (document.querySelector("#answer8").value == ("grape fruit")) {
...
function colorChange9() {
    ...
    if (document.querySelector("#answer9").value == ("Lucy")) {
...
function colorChange10() {
    ...
    if (document.querySelector("#answer10").value == ("Lucy")) {
...
function total(){
    if (i <=2){answer = "You don't know anything. Heck you!"}
    else if (i <= 5) { answer = "You know little bit" }
    else if (i <= 7) { answer = "You know little, but not much" }
    else if (i <= 10) { answer = "You know me! Am flattered" }
    alert("You got " + i + "/10. Lucy says: " + answer);
